...
import { PingiterLogItem } from '@pingiter/api/src/models/PingiterLog';
import { EEvents } from '@pingiter/api/src/enums/events';
import { getTimeAverage } from '@pingiter/api/src/util';
import { run } from '@pingiter/api';
...
program.name('pingiter').version(require('./package.json').version);
